...
class WC_RC_Shipping_Field_Copy_Paste_Button {
    ...
    private $copy_paste_button_css_id = 'copy_paste_button';
    private $info_text_area_css_id = 'info_text_area';
    ...
    public function action_admin_enqueue_scripts() {
        ...
        wp_localize_script( self::FIELD_RC_COPY_PASTE_BUTTON.'_js',
            'rc_params', array(
                'copy_paste_button_css_id' => $this->copy_paste_button_css_id,
                'info_text_area_css_id' => $this->info_text_area_css_id,
    ...
    public function action_woocommerce_admin_field_rc_copy_paste_button( $field ) {
        ...
        ob_start(); ?>
        <div>
            <textarea id="<?php echo $this->info_text_area_css_id; ?>" style="display:none;" readonly><?php echo $formatted_info; ?></textarea>
            <button type="button" id="<?php echo $this->copy_paste_button_css_id; ?>" class="button button-primary"><?php echo esc_html__('Copy the information to the clipboard', 'relais-colis-woocommerce') ?></button>
        </div>
        <?php
        echo ob_get_clean();
    }
