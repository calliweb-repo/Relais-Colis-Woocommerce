...
class WP_Tariff_Grids_DAO {
    ...
    public function insert_tariff_grid( $method_name, $criteria, $min_value, $max_value, $price ) {
        ...
        if ( $this->check_tariff_conflict( $method_name, $criteria, $min_value, $max_value ) ) {
            ...
            throw new WP_Relais_Colis_API_Exception( WP_Relais_Colis_API_Exception::ERROR_MESSAGES[ WP_Relais_Colis_API_Exception::TARIFF_GRIDS_CRITERIA_CONFLICT ], WP_Relais_Colis_API_Exception::ERROR_CODES[ WP_Relais_Colis_API_Exception::TARIFF_GRIDS_CRITERIA_CONFLICT ] );
        }
