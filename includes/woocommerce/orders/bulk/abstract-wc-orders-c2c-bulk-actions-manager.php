...
/**
 * Abstract class WC_Orders_C2c_Bulk_Actions_Manager to facilitate all C2C RC bulk actions
 * Manage Bulk actions in C2C mode:
 ...
 * @since     1.0.0
 */
abstract class WC_Orders_C2c_Bulk_Actions_Manager {
