...
/**
 * Class WC_Relacoof_Orders_C2c_Bulk_Print_Shipping_Labels_Manager
 * Manage Bulk actions in C2C mode: Print shipping Labels
 *
 ...
 * @since     1.0.0
 */
class WC_Relacoof_Orders_C2c_Bulk_Print_Shipping_Labels_Manager extends WC_Relacoof_Orders_C2c_Bulk_Actions_Manager {

    // Use Trait Singleton
    use Singleton;

    const RC_BULK_PRINT_SHIPPING_LABELS_C2C = 'rc_bulk_print_shipping_labels_c2c';
    ...
    protected function get_specific_bulk_action_slug() {
        ...
        return self::RC_BULK_PRINT_SHIPPING_LABELS_C2C;
    }
    ...
    protected function handle_specific_bulk_actions( $order_ids ) {
        ...
        $pdf_delivery_label = WC_Relacoof_Order_Packages_Manager::instance()->bulk_print_shipping_labels( $order_ids );
