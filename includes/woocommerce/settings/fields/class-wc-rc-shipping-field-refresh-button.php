...
class WC_RC_Shipping_Field_Refresh_Button {
    ...
    public function action_woocommerce_admin_field_rc_refresh_button( $field ) {
        ...
        ob_start(); ?>
        <div>
            <button type="button" class="<?php echo self::FIELD_RC_REFRESH_BUTTON; ?> button button-primary"><?php echo esc_html__('Refresh your information', 'relais-colis-woocommerce') ?></button>
        </div>
        <?php
        echo ob_get_clean();
    }
