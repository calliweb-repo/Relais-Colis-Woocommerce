jQuery(document).ready(function ($) {
                ...
                <div class="tariff-box" data-index="${tariffIndex}">
                    ...
                    <div class="lines-container">
                        ...
                        ${tariff.lines.map((line, lineIndex) => `
                            <div class="line-row">
                                <input type="number" name="tariffs[${tariffIndex}][lines][${lineIndex}][min]" value="${line.min_value}" placeholder="Min">
                                <input type="number" name="tariffs[${tariffIndex}][lines][${lineIndex}][max]" value="${line.max_value !== null ? line.max_value : ''}" placeholder="Max">
                                <input type="number" name="tariffs[${tariffIndex}][lines][${lineIndex}][price]" value="${line.price}" placeholder="Prix">
    ...
    $(document).on("click", ".add-line", function () {
        ...
        let newLine = `
            <div class="line-row">
                <input type="number" name="tariffs[${tariffIndex}][lines][${lineIndex}][min]" placeholder="Min">
                <input type="number" name="tariffs[${tariffIndex}][lines][${lineIndex}][max]" placeholder="Max">
                <input type="number" name="tariffs[${tariffIndex}][lines][${lineIndex}][price]" placeholder="Prix">
                <button type="button" class="remove-line"><i class="fas fa-trash-alt"></i></button>
            </div>`;
